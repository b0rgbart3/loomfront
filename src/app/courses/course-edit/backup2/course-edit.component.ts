...
export class CourseEditComponent implements OnInit {
    ...
    ngOnInit(): void {
       ...
       this.courseFormGroup.patchValue({'title': 'Tester', 'description': 'test Patch' });
        ...
        // console.log('Course-edit init: ' + JSON.stringify(this.course));

        if (this.id !== 0 && !this.course) {
            this.getCourse(this.id);
        } else {
           this.buildForm();
        }

        this.materialService.getMaterials(0).subscribe(
                materials => {this.materials = <Material []>materials;
                    // this.buildForm();
                 },
         ...
         if (this.course.sections) {
            ...
            for (let i = 0; i < this.course.sections.length; i++) {
             ...
             //   console.log( JSON.stringify(this.course.sections[i] ));
                ...
                this.materialFormArray[i] = this.fb.array([this.buildMaterialObjectReferenceArray()]);
                ...
                console.log('Material FOrm Array: ' + this.materialFormArray[i]);
                }
    ...
    addMaterial(i): void {
       // this.materialFormArray[i].push(this.buildMaterialReference());
    }
