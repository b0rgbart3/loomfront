...
export class StudentEnrollmentsResolver implements Resolve <Enrollment[]> {
    ...
    resolve( route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable <Enrollment[]> {
        ...
        return this.enrollmentsService.getStudentEnrollments().map( data => { this.enrollments = data;
