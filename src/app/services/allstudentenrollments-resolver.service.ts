...
export class AllStudentEnrollmentsResolver implements Resolve <Enrollment[]> {
    ...
    resolve( route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable <Enrollment[]> {
        ...
        return this.enrollmentsService.getAllStudentEnrollments().map( data => { this.enrollments = data;
